...
public class A_EntityManagerCRUDTests {
    ...
    public void selectMenuByMenuCodeTest() {
        ...
        Assertions.assertEquals(menuCode, menu2.getMenuCode());
    ...
    public void insertNewMenuTest() {
        ...
        try {
            entityManager.persist(menu); // 영속성 컨텐스트에 등록
            transaction.commit();
        } catch (Exception e) {
    ...
    public void deleteMenu() {
        ...
        Assertions.assertEquals(menuToRemove, removeMenu.getMenuName());
    }
}