...
public class ProblemOfUsingDirectSQLTests {
    ...
    /*
    * JDBC API를 이용해 직접 SQL을 다룰 떄 발생 할 수 있는 문제점
    ...
    * */
    ...
    @DisplayName("직접 SQL에 작성하여 메뉴를 조회할 떄 발생하는 문제 확인")
    @Test
    ...
    @DisplayName("직접 SQL을 작성하여 신규 메뉴를 추가 할 떄 발생하는 문제 확인")
    @Test
    ...
    **/
     ...
     * // 관계 설정이 되어있지 않으면 NullPointException이 발생 가능
     * */
    ...
    @DisplayName("조회환 두 개의 행을 담은 객체의 동일성 비교 테스트")
    @Test
