...
public class ProjectionTest {
    ...
    *
    * 2. 임베디드 타입 프로젝션
    *   - 엔티티랑 거의 비슷하게 사용된다. (조회의 시작점이 될 수 없다.) -> from에 사용 불가
    ...
    *
    * 4. new 명령어를 활용한 프로젝션
    *   -다양한 종류의 단순 값들을 DTO로 조회하는 방식 (new 패키지명 방식 (new 패키지명.DTO명)
    *   -> new 사용해서 만들기때문에 기본생성자가 필요하다.
    *   -new 명령어를 사용한 클래스는 엔티티가 아니므로 영속성 컨테스트에서 관리되지 않음
    * */
    ...
    @Test
    @DisplayName("new 명령어를 사용한 프로젝션 테스트")
    void test6() {
        //given
